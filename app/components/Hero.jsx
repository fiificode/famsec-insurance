...
const heroContent = {
  text: {
    ...
    description:
      "We understand that protecting your loved ones is of utmost importance. That's why we are dedicated to providing comprehensive solutions tailored to your familiy's unique needs. Our team is committed to creating a solid foundation of security and peace of mind for you and your loved ones.",
  },
  images: {
    img1: "/images/hero-img-1.png",
    img2: "/images/hero-img-2.png",
    img3: "/images/hero-img-3.png",
    img4: "/images/hero-img-4.png",
    img5: "/images/hero-img-5.png",
  },
};
